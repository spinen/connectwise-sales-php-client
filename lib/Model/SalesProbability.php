...
/**
 * SalesProbability Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Sales
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SalesProbability implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesProbability';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['probability'] === null) {
            $invalid_properties[] = "'probability' can't be null";
        }
